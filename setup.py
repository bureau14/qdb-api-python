...
setup(name=package_name,
      ...
      setup_requires=["setuptools_git >= 0.3", "xmlrunner >= 1.7.7", "future >= 0.17.1", "numpy >= 1.16.1", "pytest >= 4.2.0", "pytest-runner >= 4.2", "pytz >= 2018.9", "pandas >= 0.24.0", "pytest-benchmark >= 3.2.2"],
      install_requires=["xmlrunner >= 1.7.7", "future >= 0.17.1", "numpy >= 1.16.1"],
