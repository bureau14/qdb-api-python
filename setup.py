...
if is_osx:
    package_modules.extend(glob.glob(os.path.join('quasardb', '*.so')))
...
setup(name=package_name,
      ...
      setup_requires=["setuptools_git >= 0.3", "xmlrunner", "future", "numpy", "pytest", "pytest-runner", "pytz"],
      install_requires=["xmlrunner", "future", "numpy"],
