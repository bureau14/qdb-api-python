...
@pytest.mark.parametrize(
    "column_name", ["the_double", "the_int64", "the_blob", "the_string", "the_ts"]
)
def test_benchmark_dataframe_query(
    query_handler, row_count, column_name, qdbd_connection, table, benchmark
):
