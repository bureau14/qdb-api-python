...
def test_connect_throws_connection_error_when_no_cluster_public_key_file(qdbd_settings):
    with pytest.raises(quasardb.Error):
        quasardb.Cluster(
            uri=qdbd_settings.get("uri").get("secure"),
...
def test_connect_throws_connection_error_when_no_user_security_file(qdbd_settings):
    with pytest.raises(quasardb.Error):
        quasardb.Cluster(
            uri=qdbd_settings.get("uri").get("secure"),
...
def test_connect_throws_connection_error_when_mix_security_1(qdbd_settings):
    with pytest.raises(quasardb.Error):
        quasardb.Cluster(
            uri=qdbd_settings.get("uri").get("secure"),
            user_name=qdbd_settings.get("security").get("user_name"),
...
def test_connect_throws_connection_error_when_mix_security_2(qdbd_settings):
    with pytest.raises(quasardb.Error):
        quasardb.Cluster(
            uri=qdbd_settings.get("uri").get("secure"),
            user_name=qdbd_settings.get("security").get("user_name"),
...
def test_connect_throws_connection_error_when_mix_security_full(qdbd_settings):
    with pytest.raises(quasardb.Error):
        quasardb.Cluster(
            uri=qdbd_settings.get("uri").get("secure"),
            user_name=qdbd_settings.get("security").get("user_name"),
...
def test_connect_with_open_to_secure_cluster(qdbd_settings):
    with quasardb.Cluster(uri=qdbd_settings.get("uri").get("insecure")) as conn:
        topology = conn.node_topology(qdbd_settings.get("uri").get("insecure"))
