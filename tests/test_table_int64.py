...
def test_int64_get_ranges(table, intervals):
    ...
    table.int64_insert(column_name, inserted_int64_data[0], inserted_int64_data[1])
    ...
    with pytest.raises(quasardb.IncompatibleTypeError):
        table.blob_insert(column_name, inserted_int64_data[0], inserted_int64_data[1])
    ...
    with pytest.raises(quasardb.IncompatibleTypeError):
        table.timestamp_insert(
            column_name, inserted_int64_data[0], inserted_int64_data[1]
        )
