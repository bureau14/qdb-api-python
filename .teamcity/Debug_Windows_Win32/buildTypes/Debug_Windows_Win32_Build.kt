...
object Debug_Windows_Win32_Build : Template({
    name = "Build"
    ...
    params {
        text("PYTHON_CMD", "", label = "Python executable", description = """Absolutely location to Python executable to use for the build, e.g. c:\Python3.6\python.exe""", allowEmpty = false)
