...
object Release_Linux_LinuxAArch64_Python39 : BuildType({
    templates(Release_Linux.buildTypes.Release_Linux_Build)
    name = "Python 3.9"

    params {
        text("PYTHON_VERSION", "3.9.15", label = "Python version", description = "Python version to install. Files will be downloaded from s3://qdbbuilddeps/linux/python/Python-x.y.z.tgz", allowEmpty = false)
    ...
    steps {
        ...
        stepsOrder = arrayListOf("RUNNER_53", "RUNNER_62", "RUNNER_280", "RUNNER_93", "RUNNER_101", "RUNNER_56", "RUNNER_57", "RUNNER_144")
    }
