...
object Release_Linux_LinuxAArch64_Python38 : BuildType({
    templates(Release_Linux.buildTypes.Release_Linux_Build)
    name = "Python 3.8"

    params {
        text("PYTHON_VERSION", "3.8.15", label = "Python version", description = "Python version to install. Files will be downloaded from s3://qdbbuilddeps/linux/python/Python-x.y.z.tgz", allowEmpty = false)
